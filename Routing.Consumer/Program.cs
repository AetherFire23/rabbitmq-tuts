...
/*
 * Need to define routing keys into 
 */
if (args.Length < 1)
{
    Console.Error.WriteLine("Usage: {0} [info] [warning] [error]",
        Environment.GetCommandLineArgs()[0]);
    Console.WriteLine("Define relevant routing keys into program launch arguments. ");
...
/*
 * For each severity declared in args; subscribe (bind) to the relevant queue. 
 */
